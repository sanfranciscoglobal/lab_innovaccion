...
class IniciativasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $iniciativas = Iniciativas::obtenerIniciativasUserPaginate(Auth::user());
...
//    }
    ...
    public function store(StorePost $request)
    {
        ...
        try {
            ...
            if ($modelActor = IniciativaActor::find($request->iniciativa_actor_id)) {
                $modelActor->update($requestData);
            }

            if (!$modelActor) {
                //dd($requestData, $request, $modelActor);
