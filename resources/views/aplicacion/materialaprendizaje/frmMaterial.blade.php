                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="mat_nombre">* Nombre de la publicación <span style="color: gray">(max. 250 caracteres)</span> </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="mat_autor" placeholder="Autor" value="{{isset($material->autor_publicacion)?$material->autor_publicacion:old('autor_publicacion')}}" name="autor_publicacion" oninvalid="setCustomValidity('Por favor complete este campo.')" onchange="try{setCustomValidity('')}catch(e){}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
//textos en espanol
    ...
    $(document).ready(function(){
        $('#mat_nombre').setCustomValidity("Por favor llene este campo.");
