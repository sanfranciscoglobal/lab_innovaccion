                                ...
                                <article class="card h-100 border-0 box-shadow pt-4 pb-5 mx-1">
                                    ...
                                    <div class="px-4 px-xl-5 pt-2">
                                        ...
                                        <div class="row" style="margin-left:31%">
                                            @if ($material->tipo==0)
                                                <a class="btn btn-primary" href="{{route('material.detalle',[$material->slug, $material->id])}}">Ver publicación</a>
                                            @else
                                                <a class="btn btn-primary" href="{{route('material.detalle',[$material->slug, $material->id])}}">Ver herramienta</a>
                                            @endif
                                        </div>
