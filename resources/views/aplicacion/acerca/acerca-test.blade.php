@extends('layouts.aplicacion.admin')
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8 offset-lg-2">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, commodi incidunt voluptate nisi
                        ...
                        architecto magnam. Laboriosam quam beatae iste itaque? Non enim ipsum quasi?
                    </p>
                </div>
            </div>
        </div>
