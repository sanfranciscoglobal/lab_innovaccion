<div class="form-group">
    <div class="controls-container mb-3">
        ...
        Actividades culturales y de cuidado en el cultivo." required minlength="10" maxlength="280">{{ old('causas.1', $problema->causas) }}</textarea>
        ...
        Proceso deficiente en la cosecha.
        Inadecuados contenedores para el transporte de la materia prima.
        Actividades culturales y de cuidado en el cultivo." required minlength="10" maxlength="280">{{ old('causas.2', $problema->causas) }}</textarea>
        ...
        Proceso deficiente en la cosecha.
        Inadecuados contenedores para el transporte de la materia prima.
        Actividades culturales y de cuidado en el cultivo." required minlength="10" maxlength="280">{{ old('causas.3', $problema->causas) }}</textarea>
    ...
    <div class="controls-container mb-3">
        ...
        Proceso deficiente en la cosecha.
        Inadecuados contenedores para el transporte de la materia prima.
        Actividades culturales y de cuidado en el cultivo." required minlength="10" maxlength="280">{{ old('efectos.3', $problema->efectos) }}</textarea>
