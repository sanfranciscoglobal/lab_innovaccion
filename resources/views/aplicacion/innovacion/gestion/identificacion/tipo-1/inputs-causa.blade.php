<div class="form-group">
    <div class="controls-container mb-3">
        ...
        Actividades culturales y de cuidado en el cultivo."  required></textarea>
    ...
    <div class="controls-container mb-3">
        ...
        <div class="custom-control custom-radio mb-3">
            <input class="custom-control-input form-control" type="radio" id="eslabon-1" name="eslabon" value="1" required>
        ...
        <div class="custom-control custom-radio mb-3">
            <input class="custom-control-input form-control" type="radio" id="eslabon-2" name="eslabon" value="2">
        ...
        <div class="custom-control custom-radio mb-3">
            <input class="custom-control-input form-control" type="radio" id="eslabon-3" name="eslabon" value="3">
        ...
        <div class="custom-control custom-radio mb-3">
            <input class="custom-control-input form-control" type="radio" id="eslabon-4" name="eslabon" value="4">
        ...
        <div class="custom-control custom-radio mb-3">
            <input class="custom-control-input form-control" type="radio" id="eslabon-5" name="eslabon" value="5">
    ...
    <div class="controls-container mb-3">
        ...
        LA CADENA PRODUCTIVA SE HA VISTO AFECTADA PORQUE el proveedor entrega materia prima que no cumple con los estándares requeridos, LO CUAL OCASIONA uso de más tiempo y mano de obra en la clasificación de la materia prima que encarece el producto y limita el acceso a más producto exportable." required></textarea>
    </div>
    <div class="controls-container mb-3">
        <label class="control-label">* Escribe tres palabras o conceptos clave que se refieran al problema detectado</label>
        <input class="form-control mb-1" type="text" name="keyword[1]" placeholder="Concepto 1" required value="">
        <input class="form-control mb-1" type="text" name="keyword[2]" placeholder="Concepto 2" required value="">
        <input class="form-control mb-1" type="text" name="keyword[3]" placeholder="Concepto 3" required value="">
    </div>
</div>
