<div class="form-group">
    <div class="controls-container mb-3">
        ...
        <textarea class="form-control" id="textarea-input" rows="3" name="causas[]" placeholder="Ejemplo:
        ...
        <textarea class="form-control" id="textarea-input" rows="3" name="causas[2]" placeholder="Ejemplo:
        Proceso deficiente en la cosecha.
        Inadecuados contenedores para el transporte de la materia prima.
        ...
        <textarea class="form-control" id="textarea-input" rows="3" name="causas[3]" placeholder="Ejemplo:
        Proceso deficiente en la cosecha.
        Inadecuados contenedores para el transporte de la materia prima.
    ...
    <div class="controls-container mb-3">
        ...
        <textarea class="form-control" id="textarea-input" rows="3" name="efectos[3]" placeholder="Ejemplo:
        Proceso deficiente en la cosecha.
        Inadecuados contenedores para el transporte de la materia prima.
