...
<div class="form-group">
    <div class="controls-container mb-3">
        ...
        <textarea class="form-control mb-2" id="textarea-input" rows="1" name="causas[1]" required minlength="10" maxlength="280" placeholder="Ejemplo: Proceso deficiente en la cosecha.">{{ old('causas.1', $causas[1]) }}</textarea>
        @error('causas.1')<div class="invalid-feedback d-inline">{{ $message }}</div>@enderror
        <textarea class="form-control mb-2" id="textarea-input" rows="1" name="causas[2]" required minlength="10" maxlength="280" placeholder="Ejemplo: Inadecuados contenedores para el transporte de la materia prima.">{{ old('causas.2', $causas[2]) }}</textarea>
        @error('causas.2')<div class="invalid-feedback d-inline">{{ $message }}</div>@enderror
        <textarea class="form-control mb-2" id="textarea-input" rows="1" name="causas[3]" required minlength="10" maxlength="280" placeholder="Ejemplo: Actividades culturales y de cuidado en el cultivo.">{{ old('causas.3', $causas[3]) }}</textarea>
    ...
    <div class="controls-container mb-3">
        ...
        <textarea class="form-control mb-2" id="textarea-input" rows="1" name="efectos[3]" required minlength="10" maxlength="280" placeholder="Ejemplo: Actividades culturales y de cuidado en el cultivo.">{{ old('efectos.3', $efectos[3]) }}</textarea>
