                    ...
                    <div class="d-flex flex-column h-100 bg-light rounded-lg box-shadow-lg p-4">
                        <div class="py-2 p-md-3">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between pb-4 text-center text-sm-left">
                                ...
                                @if ($method=='PUT')
                                    <a class="btn btn-link text-danger font-weight-medium btn-sm mb-2"
                                       data-toggle="modal" data-target="#deleteAlert"><i
                                                class="fe-trash-2 font-size-base mr-2"></i>Eliminar evento </a>
                                @endif
                            </div>
                            <!-- Content-->
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="organizador"
                                               value="{{isset($evento->organizador)?$evento->organizador:old('organizador')}}"
                                               maxlength='250' name="organizador" placeholder="Nombre del organizador"
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="nombre"
                                                       ...
                                                       maxlength='250' name="nombre" placeholder="Nombre del evento"
                                                       oninvalid="setCustomValidity('Por favor complete este campo.')"
                                                       onchange="try{setCustomValidity('')}catch(e){}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" id="fecha"
                                                       ...
                                                       name="fecha"
                                                       oninvalid="setCustomValidity('Por favor seleccione una fecha.')"
                                                       onchange="try{setCustomValidity('')}catch(e){}" required>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="time" id="hora"
                                                       value="{{isset($evento->hora)?$evento->hora:old('hora')}}"
                                                       name="hora"
                                                       oninvalid="setCustomValidity('Por favor seleccione una hora.')"
                                                       onchange="try{setCustomValidity('')}catch(e){}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="descripcion">* Descripción del Evento <span
                                                            style="color: gray">(max. 100 palabras) (min. 50 palabras)</span>

                                                    <textarea oninput="countWords();" id="descripcion"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3">
                                                    <label for="evento_virtual">
                                                        <input class="lugar" type="radio" id="evento_virtual" value="0"
                                                               name="tipo" required>
                                                        Virtual
                                                    </label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <label for="evento_presencial">
                                                        <input class="lugar" type="radio" id="evento_presencial"
                                                               value="1" name="tipo">
                                                        Presencial
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="col-md-12 to-hide e-virtual d-none">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="url" id="url"
                                                                   value="{{isset($evento->url)?$evento->url:old('url')}}"
                                                                   name="url"
                                                                   placeholder="Ejem. https://link-del-evento.com?u=lkasdf78ia4l5"
                                                                   oninvalid="setCustomValidity('Ingrese el link añadiendo https o http.')"
                                                    ...
                                                    <div class="col-md-12 to-hide e-presencial d-none">
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select style="width:100%;" id="canton_id"
                                                                            class="form-control select2" name="canton"
                                                                            ...
                                                                            required="required"
                                                                            oninvalid="setCustomValidity('Por favor seleccione una opción de la lista.')"
                                                                            onchange="try{setCustomValidity('')}catch(e){}"></select>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label for="ubicacion">* Ubicación del
                                                                        Evento</label>
                                                                    <input class="form-control" type="text"
                                                                           id="evento_direccion"
                                                                           value="{{isset($evento->ubicacion)?$evento->ubicacion:old('ubicacion')}}"
                                                                           name="ubicacion"
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <input type="hidden" type="text" id="lat" name="org_lat"
                                                                       value="{{isset($evento->org_lat)?$evento->org_lat:'0'}}">
                                                                <input type="hidden" type="text" id="long"
                                                                       name="org_long"
                                                                       value="{{isset($evento->org_long)?$evento->org_long:'0'}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($method=='PUT')
                                            <input type="file" class="dropify" accept="image/gif, image/jpeg, image/png"
                                                   id="imagen" value="" name="imagen"
                                                   data-default-file="{{asset('storage/eventos').'/'.$evento->imagen}}">

                                        @else
                                            <input type="file" class="dropify" accept="image/gif, image/jpeg, image/png"
                                                   id="imagen" value="" name="imagen"
                                                   oninvalid="setCustomValidity('Por favor seleccione una imagen.')"
                                                   onchange="try{setCustomValidity('')}catch(e){}" required>
                                        @endif
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                                        <div class="custom-control custom-checkbox d-block">
                                            <input class="custom-control-input" type="checkbox" id="verificada"
                                                   name="terminos" value="1"
                                                   oninvalid="setCustomValidity('Por favor marca esta casilla si tu quieres continuar.')"
                                                   onchange="try{setCustomValidity('')}catch(e){}" required>
                                            <label class="custom-control-label" for="verificada">* Declaro que conozco
                                                los términos y condiciones de esta plataforma y autorizo que se
                                                publiquen todos los datos registrados en este formulario.</label>
                                        </div>
                                        @if ($method=='PUT')
                                            <button class="btn btn-primary mt-3 mt-sm-0" id='submitbutton'
                                                    type="submit"><i class="fe-save font-size-lg mr-2"></i>Actualizar
                                            </button>
                                        @else
                                            <button class="btn btn-primary mt-3 mt-sm-0" id='submitbutton'
                                                    type="submit"><i class="fe-save font-size-lg mr-2"></i>Enviar
                                            </button>
                                        @endif
