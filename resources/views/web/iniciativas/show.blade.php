    ...
    <section class="container mt-4 pt-5">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('web.iniciativas.index')}}">Iniciativas de Actores</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{$iniciativa->nombre_iniciativa}}</li>
            </ol>
        </nav>
        <div class="my-2">
