<div class="bg-overlay-content">
    <div class="row m-0">
        <div style="top:15px; position:absolute; z-index:10;  width: 100%;">
            ...
            <div class="ml-lg-5 mx-md-3 px-7 align-items-center d-none d-lg-block">
                <div id="mapacabezagrande" style="background-color: rgba(255, 255,255, 0.7);"
                     class="py-3 d-flex flex-column h-100 rounded-lg box-shadow-lg p-2">
                        ...
                        <div class="col-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 pl-5 py-2">
                                    <a style="border-color:#FF7F00;background: #FF7F00;white-space: normal;font-size: 16px; "
                                       href="{{route('app.iniciativas.create')}}"
                                       class="font-weight-bold btn btn-primary btn-block">Registra tu iniciativa</a>
                                </div>
                                ...
                                <div class="col py-2">
                                    <div class="input-group">
                                                <span class="input-group-prepend">
                                                    <div class="input-group-text  border-right-0"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col py-2 pr-5">
                                    <a href="{{route('web.iniciativas.analiticas')}}"
                                       class="font-weight-bold btn btn-primary btn-block">ANALÍTICA</a>
                                </div>
                            </div>
                        </div>
            ...
            <div id="mapacabezapequeño" style="background-color: rgba(255, 255,255, 0.7);"
                 class="d-block d-lg-none py-3 d-flex flex-column h-100 rounded-lg box-shadow-lg p-2 mx-4">
                <div class="row justify-content-center center-block text-center">
                    <div class="col-2">
        ...
        <!-- Filtros-->
        <div id="mapafiltrosgrande" class="d-none d-lg-block"
             style="bottom:20px; position:absolute; z-index:10; width: 100%;">
            <div class="ml-lg-5 mx-md-3 px-7 align-items-center">
                <div class=" d-flex flex-column h-100 rounded-lg box-shadow-lg p-2"
                     style="background-color: rgba(255, 255,255, 0.7);">
                    <form id="filter-iniciativas" action="{{route('web.iniciativas.data')}}" method="POST">
                        @method('POST')
                        @csrf
                            ...
                            <div class="w-100 center-block text-left pl-5 pt-1">
                                ...
                                <div class="row pt-1 ml-2 mr-2 align-items-center">
                                    <div class="col-12">
                                        <span class="ml-3 font-weight-bold  d-block"
                                              style="font-size: 15px;color:#531c6a " for="to-destination">Tipo Instituci&oacute;n</span>
                                    ...
                                    <div class="col-12">
                                        <span class="ml-3 font-weight-bold  d-block"
                                              style="font-size: 15px;color:#531c6a ">Población Objetivo</span>
                                    ...
                                    <div class="col-lg-2 col-xl-2  col-md-2 col-sm-3 pt-3">
                                        <button type="button"
                                                ...
                                                data-action="{{route('web.iniciativas.data')}}">
                                            Aplicar
                                        </button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="font-weight-bold d-flex justify-content-end col-md-5">
                                        <button type="button" class="font-weight-bold btn btn btn-primary mr-3 dropdown-toggle"
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a type="button" class=" ml-3 export"
