...
<html>
	...
	>
		...
		>
			<tr>
				<td align="center" valign="top">
					...
					>
						<tr>
							<td class="whiteBgcolor" align="center" valign="top" bgcolor="#5f27cd">
								<table
									class="row"
									width="600"
									border="0"
								...
								>
									...
									<tr>
										<td align="left" valign="top" style="font-size:0;padding:0">
											...
											<div class="row" style="display:inline-block;max-width:400px;vertical-align:middle;width:100%">
												<table class="row" border="0" align="left" cellpadding="0" cellspacing="0">
													<tr>
														<td
															class="Headlines centerText"
															align="left"
															valign="middle"
															style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#FFFFFF;font-size:30px;line-height:40px;font-weight:600;letter-spacing:0px;padding:0;"
														>
															Texto Enlace
														</td>
													</tr>
											...
											<div class="row" style="display:inline-block;max-width:180px;vertical-align:middle;width:100%">
												<table class="row" border="0" align="left" cellpadding="0" cellspacing="0">
													<tr>
														<td align="center" valign="top">
															<table border="0" align="center" cellpadding="0" cellspacing="0" class="centerFloat">
																<tr>
																	<td
																		class="Button2"
																		align="center"
																		style="background-color:#000000;font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:12px; font-weight:600; color:#FFFFFF; line-height:24px;letter-spacing:1px;padding:10px 28px;border-radius:0px;"
																	>
									...
									<![endif]-->
											...
											>
												...
												<tr>
													...
													>
														En Thinkia puedes ..... <br />Encuentra ....
													</td>
												</tr>
													...
													<td align="center" valign="top">
														<table border="0" align="center" cellpadding="0" cellspacing="0" class="centerFloat">
															<tr>
																...
																>
																	<a href="https://example.com/" style="text-decoration:none; color:#5f27cd;"
																		>VISITA ENLACE</a
																	>
																</td>
															</tr>
		...
		<!-- Title Description With Line 9 Open -->
		<table
			class="bodyBgColor"
			width="100%"
			border="0"
		...
		<!-- Title Description With Line 9 Close -->

		<!-- Blog 1 Colume left 1 Open -->
		<table
			class="bodyBgColor"
			mc:hideable
			width="100%"
														...
														>
															<a href="https://example.com/" style="text-decoration:none;border:0">
																<img
																	...
																	border="0"
																	width="280"
																	style="display:block;border:0;width:100%;max-width:280px"
																/>
															</a>
														</td>
													</tr>
															...
															<table class="row" border="0" align="left" cellpadding="0" cellspacing="0">
																<tr>
																	<td
																		...
																		align="left"
																		valign="middle"
																		style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#5f27cd;font-size:12px;line-height:26px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:5px;"
																	>
																		JUN 15, 2020
																	</td>
																</tr>
																...
																<tr>
																	<td
																		...
																		align="left"
																		valign="middle"
																		style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#191919;font-size:20px;line-height:30px;font-weight:600;letter-spacing:0px;padding:0;padding-bottom:10px;"
																	>
																		Título 1
																	</td>
																</tr>
																...
																<tr>
																	<td
																		...
																		align="left"
																		valign="middle"
																		style="font-family:'Poppins', sans-serif;color:#4c5267;font-size:14px;line-height:22px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:20px;"
																	>
																		...
																		<table border="0" align="left" cellpadding="0" cellspacing="0">
																			<tr>
																				<td
																					...
																					align="left"
																					valign="middle"
																					style="font-family:'Poppins',Arial,Helvetica,sans-serif;color:#5f27cd;font-size:14px;line-height:26px;font-weight:700;letter-spacing:0px;padding:0;"
																				>
																					<a href="https://example.com/" style="text-decoration:none; color:#5f27cd;"
																						>READ MORE ⇾</a
																					>
		...
		<!-- Blog 1 Colume left 1 Close -->

		<!-- Blog 1 Colume left 2 Open -->
		<table
			class="bodyBgColor"
			mc:hideable
			width="100%"
