										...
										<td class="containerPadding" align="center" valign="top" style="font-size:0;padding:0">
											...
											>
												<tr>
													...
													>
														Hola de nuevo {{ $solucion->problemaid->user->name }}!
													</td>
												</tr>
												...
												<tr>
													...
													>
														Alguien ha publicado una nueva solucion a tú problema.<br />
														Te dejamos su email por siquieres contactarlo: {{ $solucion->user->email }}<br />
													</td>
												</tr>
											</table>
										</td>
