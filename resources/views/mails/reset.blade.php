										...
										<td class="containerPadding" align="center" valign="top" style="font-size:0;padding:0">
											...
											>
												...
												<tr>
													...
													>
														Hola de nuevo {{ $user->name }}.<br />
														Has recibido este correo porque deseas cambiar tu contraseña.<br />
														Si no lo enviaste tú por favor ponte en contacto.<br />
													</td>
												</tr>
											</table>
										</td>
									...
									<![endif]-->
											...
											>
												...
												<tr>
													...
													>
														Para cambiar tu contraseña da click en el enlase siguiente
													</td>
												</tr>
													...
													<td align="center" valign="top">
														<table border="0" align="center" cellpadding="0" cellspacing="0" class="centerFloat">
															<tr>
																...
																>
																	<a href="{{ route('password.login', ['user' => $user->id, 'hash' => $user->verification_token]) }}" style="text-decoration:none; color:#5f27cd;">Cambiar contraseña</a>
																</td>
															</tr>
														</table>
													</td>
