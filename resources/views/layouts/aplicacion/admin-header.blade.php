<header class="cs-header navbar navbar-expand-lg navbar-dark navbar-floating navbar-sticky d-block p-0 secondary-nav"
        data-scroll-header>
            ...
            <div class="row w-100">
                <div class="col-12 d-flex justify-content-end align-items-center">
                    ...
                    <ul class="d-flex justify-content-space-around list-inline align-items-center ml-4 mb-0">
                        <li class="list-inline-item"><a class=" social-btn sb-outline sb-facebook sb-dark sb-sm mr-2"
                                                        href="#">
                                <i class="fe-facebook"></i>
                            </a></li>
                        <li class="list-inline-item"><a class=" social-btn sb-outline sb-twitter sb-dark sb-sm mr-2"
                                                        href="#">
                                <i class="fe-twitter"></i>
                            </a></li>
                        <li class="list-inline-item"><a class=" social-btn sb-outline sb-instagram sb-dark sb-sm mr-2"
                                                        href="#">
                                <i class="fe-instagram"></i>
                            </a></li>
                        <li class="list-inline-item"><a
                                    class="text-white social-btn sb-outline sb-youtube sb-dark sb-sm mr-2" href="#">
            ...
            */ ?>
            @if (Auth::check())
                ...
                <div class="navbar-tool dropdown">
                    ...
                    <a class="navbar-tool-label dropdown-toggle " data-toggle="dropdown" aria-haspopup="true"
                       aria-expanded="false">
            ...
            <div class="cs-offcanvas-body">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('acercade') }}">Gestion</a></li>
                            <li><a class="dropdown-item" href="{{ route('elequipo') }}">Iniciativas</a></li>
                            <li><a class="dropdown-item" href="{{ route('valores') }}">Valores</a></li>
                            <li><a class="dropdown-item" href="{{ route('terminoscondiciones') }}">Términos y
                                    condiciones</a></li>
                            <li><a class="dropdown-item" href="{{ route('faq') }}">Preguntas frecuentes</a></li>
